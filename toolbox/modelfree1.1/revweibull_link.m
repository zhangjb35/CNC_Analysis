...
%
% Reverse Weibull link in cell form for use with GLMFIT, GLMVAL and other
% Matlab GLM functions. The guessing rate and lapsing rate are fixed, and
% power parameter is set to be equal K; hence link is a function of only
% one variable.
%
% INPUT
% 
