function [ci,th0] = bootstrap_ci_th(TH,r,m,x,N,h0,alpha,X,link,guessing,lapsing,...
                        K,p,ker,maxiter,tol)
%
% Bootstrap estimate of a confidence interval at a significance level alpha
% for the estimated threshold for the local polynomial estimate of the
% psychometric function with given guessing and lapsing rates. The
